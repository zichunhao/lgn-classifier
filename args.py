...
def setup_argparse():
    ...
    parser.add_argument('--p4_into_CG', default=False, action='store_true',
                        help='Feed 4-momenta themselves to the first CG layer, in addition to scalars. Default: True')
    parser.add_argument('--add-beams', default=False, action='store_true',
                        help='Whether to two proton beams of the form (m^2,0,0,+-1) to each event. Default: False')
    parser.add_argument('--full-scalars', default=False, action='store_true',
    ...
    parser.add_argument("--test-equivariance", default=False, action='store_true',
                        help="Whether to test the equivariance of the trainined model. Default: True")
    parser.add_argument("--test-over-all-epochs", default=False, action='store_true',
    ...
    parser.add_argument("--suffix", type=str, default=None,
                        help="An extra suffix to append to the saving directory.")
    parser.add_argument("--patience", type=int, default=10,
                        help="Patience before early stopping. Default: 10")
    parser.add_argument('--print-logging', default=False, action='store_true',
                        help='Whether to print all logging info. Default: False')
    """
    parser.add_argument("--train", default=False, action='store_true',
                        help="Whether to train the model. Default: True")
    parser.add_argument("--load-to-test", default=False, action='store_true',
