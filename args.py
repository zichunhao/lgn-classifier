...
def setup_argparse():
    ...
    parser.add_argument('--p4_into_CG', action="store", default=True,
                        help='Feed 4-momenta themselves to the first CG layer, in addition to scalars. Default: True')
    parser.add_argument('--add-beams', action="store", default=False,
                        help='Whether to two proton beams of the form (m^2,0,0,+-1) to each event. Default: False')
    parser.add_argument('--full-scalars', action="store", default=True,
    ...
    parser.add_argument('--mlp', action="store", default=True,
    ...
    # trainin options
    parser.add_argument("--load-to-train", action="store", default=False,
    ...
    parser.add_argument("--test-equivariance", action="store", default=True,
                        help="Whether to test the equivariance of the trainined model. Default: True")
    parser.add_argument("--test-over-all-epochs", action="store", default=True,
    ...
    parser.add_argument('--print-logging', action="store", default=True,
                        help='Whether to print all logging info. Default: False')
    """
    parser.add_argument("--train", action="store", default=True,
                        help="Whether to train the model. Default: True")
    parser.add_argument("--load-to-test", action="store", default=False,
